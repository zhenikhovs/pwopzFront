        ...
        <section className="flex items-center h-full p-16 bg-gray-900 text-gray-100">
            <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8">
                <div className="max-w-md text-center">
                    ...
                    <p className="text-2xl font-semibold md:text-3xl">Извините, мы не смогли найти страницу.</p>
                    <p className="mt-4 mb-8 text-gray-400">Проверьте адрес или вернитесь на главную страницу.</p>
